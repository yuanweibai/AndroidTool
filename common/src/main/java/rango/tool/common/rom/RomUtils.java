...
import rango.tool.common.utils.Compats;
...
public class RomUtils {
    ...
    public static boolean atLeastHuaweiEmui8_1() {
        ...
        if (emuiVersion.contains("EmotionUI_")) {
            emuiVersion = emuiVersion.replaceAll("EmotionUI_", "").trim();
        } else {
            emuiVersion = emuiVersion.replaceAll("EmotionUI", "").trim();
        }

        emuiVersion = emuiVersion.replaceAll("\\.", "");
        try {
            int emuiVersionInt = Integer.parseInt(emuiVersion);
            while (emuiVersionInt / 100 < 0) {
                emuiVersionInt = emuiVersionInt * 10;
            }
            return emuiVersionInt >= 810;
